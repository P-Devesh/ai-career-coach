...
with st.sidebar:
    ...
    <div style="text-align: center; font-size: 11px; color: gray;">
        Built by <strong>Devesh Kumar P</strong><br>
        <a href="mailto:deveshkumar2048@gmail.com" target="_blank">Gmail</a> &nbsp; | &nbsp;
        <a href="https://www.linkedin.com/in/deveshkumar2048" target="_blank">LinkedIn</a> &nbsp; | &nbsp;
        <a href="https://github.com/deveshkumar2048" target="_blank">GitHub</a>
    </div>
    """, unsafe_allow_html=True)
    ...
    if st.button("▶️ Generate Cover Letter"):
        if not resume_file or not jd.strip():
            ...
            with st.spinner("Generating cover letter..."):
                path = os.path.join("data/uploads", resume_file.name)
